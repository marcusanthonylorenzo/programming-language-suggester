...
$(document).ready(function () {
  $("#form").submit(function(event) {
    ...
    if (totalValueResult <26) {
      ...
      display.html("<div class='closeBox'><button class='close'>X</button></div><div class='popUp' id='error'><h4>Don't be lazy!</h4> <p>Please make sure you've actually clicked all the buttons.</p></span><img src='css/images/steve.jpg' id='steve'><p id='parkour'>'parkour'</p></div>").show();
      outputBox.show();
      const closeButton = $(".close");
      closeButton.click(function() {
        outputBox.hide();
