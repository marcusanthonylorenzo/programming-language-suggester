...
$(document).ready(function () {
  $("#form").submit(function(event) {
    ...
    if (totalValueResult <19) {
      ...
      display.html("<div class='closeBox'><button class='close'>X</button></div><div class='popUp' id='error'><h4>Uhh...Don't be lazy!</h4><img src='css/images/catLoading.jpg' id='cat' alt='cat'><p>Please make sure you've actually clicked all the buttons.</p></span><img src='css/images/steve.jpg' id='steve' alt='steve'><p id='parkour'>'parkour'</p></div>").show();
      outputBox.show();
      container.addClass("bgFade");
      const closeButton = $(".close");
      closeButton.click(function() {
